...
# Week 7: AI Activity Instructions

In this folder, the student will find the neccessary files for this week activities.

To start the activity do the following steps
